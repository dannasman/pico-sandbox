...
#define PLL_SYS_CS_LOCK(v)      ((_u(v) & _u(0x1)) << _u(31))
#define PLL_SYS_CS_LOCK_MASK    PLL_SYS_CS_LOCK(ALL1)
#define PLL_SYS_CS_LOCK_N(v)    ((_u(v) & _u(0x1)) << _u(30))
#define PLL_SYS_CS_LOCK_N_MASK  PLL_SYS_CS_LOCK_N(ALL1)
#define PLL_SYS_CS_BYPASS(v)    ((_u(v) & _u(0x1)) << _u(8))
#define PLL_SYS_CS_BYPASS_MASK  PLL_SYS_CS_BYPASS(ALL1)
#define PLL_SYS_CS_REFDIV(v)    ((_u(v) & _u(0x3f)) << _u(0))
#define PLL_SYS_CS_REFDIV_MASK  PLL_SYS_CS_REFDIV(ALL1)

#define PLL_SYS_PWR_VCOPD(v)        ((_u(v) & _u(0x1)) << _u(5))
#define PLL_SYS_PWR_VCOPD_MASK      PLL_SYS_PWR_VCOPD(ALL1)
#define PLL_SYS_PWR_POSTDIVPD(v)    ((_u(v) & _u(0x1)) << _u(3))
#define PLL_SYS_PWR_POSTDIVPD_MASK  PLL_SYS_PWR_POSTDIVPD(ALL1)
#define PLL_SYS_PWR_DSMPD(v)        ((_u(v) & _u(0x1)) << _u(2))
#define PLL_SYS_PWR_DSMPD_MASK      PLL_SYS_PWR_DSMPD(ALL1)
#define PLL_SYS_PWR_PD(v)           ((_u(v) & _u(0x1)) << _u(0))
#define PLL_SYS_PWR_PD_MASK         PLL_SYS_PWR_PD(ALL1)

#define PLL_SYS_FBDIV_INT(v)    ((_u(v) & _u(0xfff)) << _u(0))
#define PLL_SYS_FBDIV_INT_MASK  PLL_SYS_FBDIV_INT(ALL1)

#define PLL_SYS_PRIM_POSTDIV1(v)    ((_u(v) & _u(0x3)) << _u(16))
#define PLL_SYS_PRIM_POSTDIV1_MASK  PLL_SYS_PRIM_POSTDIV1(ALL1)
#define PLL_SYS_PRIM_POSTDIV2(v)    ((_u(v) & _u(0x3)) << _u(12))
